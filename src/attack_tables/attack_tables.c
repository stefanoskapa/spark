...
1.  Initialize 
    Initialize bishop attack tables which contain 
...
2.  Retrieve
    Retrieve as fast as possible a bitboard that
    represents the squares the bishop attacks in a 
    given position. This will be done by acccessing
...
*/
U64 get_bishop_attacks_with_blockers(int square, U64 blocker) {
    U64 attacks = 0ULL;
    int rank, file;
    int start_rank = square / 8;
    int start_file = square % 8;
...
can attack, given a specific blocker configuration 
*/
U64 get_rook_attacks_with_blockers(int square, U64 blocker) {
    U64 attacks = 0ULL;
    int rank, file;
    int start_rank = square / 8;
    int start_file = square % 8;
